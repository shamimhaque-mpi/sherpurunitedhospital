...
<html lang="en">
	<head>
		...
		<title><?php echo str_replace('_',' ',$site_name) . ' | ' . ucwords(str_replace('_',' ', $meta_title)); ?></title>
		<!--========================Library Style Sheet========================-->
			...
			<div class="row form-wrapper">
					...
					?>
						<div class="form-border">
							...
							<div class="l-form-group no-border">
								<a class="l-text" href="<?php echo base_url(); ?>">Back to Home</a>
								<a class="r-text" href="">Forgot Password?</a>
							</div>
						</div>
					<?php echo form_close();?>
			</div>
