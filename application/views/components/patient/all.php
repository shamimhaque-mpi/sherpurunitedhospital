...
<div class="container-fluid">
    <div class="row" ng-controller="allPatientsCtrl">
                ...
                <table class="table table-bordered" ng-cloak>
                    ...
                    <tr dir-paginate="patient in allPatients|filter:search|itemsPerPage:perPage|orderBy:sortField:reverse">
                        ...
                        <td class="none" style="width: 160px;">
                            ...
                            <?php if(ck_action("patient_menu","view")){ ?>
                            ...
                            <?php if(ck_action("patient_menu","edit")){ ?>
                            <a title="Edit" class="btn btn-warning" href="<?php echo site_url('patientbasicInfo/view?id={{patient.pid}}&&wno={{patient.ward_no}}');?>" ><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                            <?php } ?>                            

                            <?php if(ck_action("patient_menu","delete")){ ?>
                            <a title="Delete" class="btn btn-danger" onclick="return confirm('Are you sure want to Delete this Patient?');" href="<?php echo site_url('patient/admission/delete/{{patient.id}}');?>" ><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                            <?php } ?>                       
