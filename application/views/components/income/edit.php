...
<div class="container-fluid block-hide">
    ...
    echo form_open('income/income/update_income/'.$income[0]->id, $attribute);
    ?>
            ...
            <div class="panel-body no-padding">
                ...
                <div class="col-md-9">                                
                        ...
                        <div class="col-md-7">
                            <select name="income_field" class="form-control">
                              <?php foreach ($income_fields as $key => $value) {?>
                                  <option <?php if($income[0]->income_field == $value->code){ echo "selected"; }?> value="<?php echo $value->code; ?>"><?php echo $value->income_field; ?></option>
                              <?php } ?>                             
                             </select> 
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <input type="number" name="amount" class="form-control" value="<?php echo $income[0]->amount; ?>" placeholder="BDT">
                            </div>
                        </div>
