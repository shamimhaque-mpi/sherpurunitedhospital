...
<div class="container-fluid" ng-controller="GroupWiseDiagnosisCtrl">
    <div class="row" ng-cloak>
        <?php echo $this->session->flashdata("confirmation"); ?>
        <div class="panel panel-default">
            <div class="panel-heading">
                <div class="panal-header-title pull-left">
                    <h1>Group Wise Diagnosis</h1>
                </div>
            </div>
            ...
            <div class="panel-body">
                ...
                echo form_open('diagnosis/group_wise_diagnosis/add', $attr); 
                ?>
                    ...
                    <div>
                        ...
                        <div class="col-md-3 mb15">
                           ...
                           <select 
                                ...
                                data-live-search="true"
                                ng-model='group_id'
                                ng-change="addAllGroupItemFn(group_id);" 
                                required >
                                <option value="" selected disable>-- Select A Group --</option>
                                <?php foreach($allGroupName as $val){ ?>
                ...
                <table class="table cus-table table-bordered">
                    ...
                    <tr ng-repeat="item in testList" ng-cloak>
                        ...
                        <td>
                            <input type="text" class="form-control" ng-value="item.testName" readonly>
                            <input type="hidden" name="test_id[]" ng-value="item.test_id" readonly>
                        </td> 
                        
                        <td style="padding: 4px 8px !important;">
                            <input type="text" class="form-control" ng-value="item.testGroup" readonly>
