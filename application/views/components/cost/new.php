        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body no-padding">
                ...
                <div class="col-md-9">                                
                        ...
                        <div class="form-group">
                            <label for="" class="col-md-3 control-label">Field of Cost <span class="req">*</span></label>
                            <div class="col-md-7">
                                <select name="cost_field" class="selectpicker form-control" data-show-subtext="true" data-live-search="true" required>
