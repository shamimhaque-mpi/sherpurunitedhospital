<div class="container-fluid" ng-controller="PcCommissionUpdateCtrl">
    <div class="row">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <?php echo $confirmation; $attr = array('class' => 'form-horizontal');
                echo form_open('', $attr); ?> 
                ...
                <div class="form-group">
                    <label for="" class="col-md-2 control-label">Total Commission(৳) </label>
                    <div class="col-md-5">
