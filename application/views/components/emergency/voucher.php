    ...
    <?php echo $this->session->flashdata('confirmation'); ?>
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                $where = array("pid" => $info[0]->pid, "title" => "emergency");
                $billsInfo = $this->action->read('bills', $where);
                ?>

                <div class="row">
                    <label class="col-xs-6">Voucher No: <?php echo $billsInfo[0]->voucher;; ?></label>
                    <label class="col-xs-6 text-right">Date: <?php echo $info[0]->date; ?></label>
                </div>
                ...
                <table class="table table-bordered">
                    <tr>
                        <th class="text-center" colspan="3">Remark</th> 
                    </tr>
                    <tr>
                        <td colspan="3"><?php echo v_check(filter($info[0]->notes)); ?></td> 
                    </tr>
