        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                ?>
                    ...
                    <div class="form-group">
                        <label class="col-md-2 control-label">Holder Mobile<span class="req">*</span></label>

                        <div class="col-md-5">
                            <input type="text" name="account_holder_contact" placeholder="Type Account Holder Mobile" class="form-control" required>
                        </div>
                    </div>
