...
class Dashboard extends Admin_controller{
    ...
    public function index() {
        ...
        // get total due
        $due_list = $this->action->read_sum('due_payment',"due");
        $this->data['totalDue'] = $due_list[0]->due;
        ...
        //$this->data['today_consultancy'] = $this->action->readGroupBy("consultancy","consultancy_no",array('date'=>date("Y-m-d")));
        $this->data['today_consultancy'] = null;
        $this->data['today_operations'] = null;
        $this->data['today_investigation'] = $this->action->read("investigation",array('date'=>date("Y-m-d")));
