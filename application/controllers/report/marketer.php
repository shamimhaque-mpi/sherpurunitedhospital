...
class Marketer extends Admin_Controller {
    ...
    public function index() {
        ...
        $this->data['subMenu'] = 'data-target="marketer"';
        
        $this->data['confirmation'] = $this->data['marketerCom'] = null;
        ...
        $this->load->view('components/report/marketer', $this->data);
