...
app.controller('ClientEditTransactionCtrl', ['$scope', '$http', function($scope, $http) {
	...
	$scope.getTotalFn = function() {
	    let remission = (typeof $scope.remission !== 'undefined') ? parseFloat($scope.remission) : 0;
		let total = (parseFloat($scope.balance) - remission) - (parseFloat($scope.payment) - parseFloat($scope.prevPayment));
